...
This basic structure allows you to build complex automations for various development tasks, such as [Automated testing](/repository_setup_guides/ci_cd/automated_testing/) and [Automated releases](/repository_setup_guides/ci_cd/releases/).
