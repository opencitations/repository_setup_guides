...
hero:
  ...
  actions:
    - text: Use the template
      link: /repository_setup_guides/getting_started/python_package_template/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
...
- **[Python package template](/repository_setup_guides/getting_started/python_package_template/)** - Create a new package with pre-configured CI/CD
