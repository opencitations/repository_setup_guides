---
title: Understanding semantic commits
description: Standardized commit message format for readable history and automation
---
...
-   **Automation:**
    ...
    -   **Semantic versioning:** tools can automatically determine the next version number (MAJOR, MINOR, PATCH) based on the types (`feat`, `fix`) and breaking changes in the commits since the last release. This is utilized by tools like `semantic-release`, as shown in the [Automated releases guide](/repository_setup_guides/ci_cd/releases/).
